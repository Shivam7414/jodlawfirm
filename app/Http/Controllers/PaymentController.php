...
class PaymentController extends Controller
{
    ...
    public function callBack(Request $request) {
        ...
        $transaction->bank_transaction_id = $payment->acquirer_data->bank_transaction_id;
        ...
        return redirect()->route('account.application.detail', $application->id)->with('success', 'Payment successful');
    }

    public function paymentUrlcallBack(Request $request){
        pred($request->all());
    }
}